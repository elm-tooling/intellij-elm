...
main =
    let
        foo<EOLError descr="COLON, EQ, LEFT_BRACE, LEFT_PARENTHESIS, LEFT_SQUARE_BRACKET, LOWER_CASE_IDENTIFIER, NUMBER_LITERAL, OPEN_CHAR, OPEN_QUOTE, UNDERSCORE or UPPER_CASE_IDENTIFIER expected"></EOLError>
    in
