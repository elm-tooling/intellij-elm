    ...
    fun `test persistence roundtrip`() {
        ...
        val xml = """
            <state>
              ...
              <settings elmCompilerPath="${toolchain.elmCompilerPath}" lamderaCompilerPath="" elmFormatPath="${toolchain.elmFormatPath}" elmTestPath="${toolchain.elmTestPath}" elmReviewPath="" isElmFormatOnSaveEnabled="true" isElmReviewOnTheFlyEnabled="true" />
            </state>
            """.trimIndent()
