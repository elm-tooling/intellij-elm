    ...
    fun `test persistence roundtrip`() {
        ...
        val xml = """
            <state>
              ...
              <settings elmCompilerPath="${toolchain.elmCompilerPath}" lamderaCompilerPath="" elmFormatPath="${toolchain.elmFormatPath}" elmTestPath="${toolchain.elmTestPath}" isElmTestRsEnabled="false" elmReviewPath="" isElmFormatOnSaveEnabled="true" />
            </state>
            """.trimIndent()
