...
class ElmPsiFactory(private val project: Project) {
    ...
    fun createPipeChain(
        ...
        indent: String,
        valueAndFunctionApplications: List<Any>
    ): ElmParenthesizedExpr {
        ...
        return createFromText(stringForExpression)
            ?: error("Invalid value ElmBinOpExpr: `($pipeChainBuilder\n\n$indent)`")
    }
    ...
    fun createParens(text: String, indentation: String = "    "): ElmParenthesizedExpr {
        ...
        return createFromText ?: error("Invalid value Paren Expression: `($text\n    )`")
    }

    fun createParensWithComments(
    ...
    fun callFunctionWithArgumentAndComments(
        comments: List<PsiComment>,
        outer: String,
        inner: ElmPsiElement,
        indent: String = ""
